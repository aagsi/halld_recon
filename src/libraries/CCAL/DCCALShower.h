...
class DCCALShower : public JObject {
  public:
	  ...
	  AddString(items, "x(cm)",     "%2.2f",  x);
	  AddString(items, "y(cm)",     "%2.2f",  y);
	  AddString(items, "z(cm)",     "%3.1f",  z);
	  AddString(items, "x1(cm)",    "%2.2f",  x1);
	  AddString(items, "y1(cm)",    "%2.2f",  y1);
	  AddString(items, "chi2",      "%3.2f",  chi2);
	  ...
	  AddString(items, "sigma_E",   "%1.3f",  sigma_E);
